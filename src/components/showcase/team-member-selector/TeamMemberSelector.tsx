...
export function TeamMemberSelector({
  ...
  // Apply defaultDepartment on mount and when it becomes available later
  useEffect(() => {
  ...
  // Ensure the current selection stays valid when option set changes
  useEffect(() => {
  ...
  // Handle spacebar at Command level to toggle the cmdk-selected item
